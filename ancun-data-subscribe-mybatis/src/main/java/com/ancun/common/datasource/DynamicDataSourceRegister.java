...
public class DynamicDataSourceRegister
    ...
    private void initCustomDataSources(Environment env) {
        ...
        RelaxedPropertyResolver propertyResolver = new RelaxedPropertyResolver(env, "biz.datasource.");
        String dsPrefixStr = propertyResolver.getProperty("names");
        List<String> dsPrefixs = Splitter.on(",").omitEmptyStrings().trimResults().splitToList(dsPrefixStr);
