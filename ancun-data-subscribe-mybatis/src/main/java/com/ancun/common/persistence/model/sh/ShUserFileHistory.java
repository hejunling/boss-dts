...
@Table(name = "user_file_history")
public class ShUserFileHistory {
    /**
     * 文件编号
     */
    @Id
     ...
     * 目录编号
     */
    @Column(name = "PF_DIRECTORY_NO")
    private String pfDirectoryNo;
     ...
     * 获取目录编号
     *
     * @return PF_DIRECTORY_NO - 目录编号
     */
    public String getPfDirectoryNo() {
        return pfDirectoryNo;
    }

    /**
     * 设置目录编号
     *
     * @param pfDirectoryNo 目录编号
     */
    public void setPfDirectoryNo(String pfDirectoryNo) {
        this.pfDirectoryNo = pfDirectoryNo;
    }
