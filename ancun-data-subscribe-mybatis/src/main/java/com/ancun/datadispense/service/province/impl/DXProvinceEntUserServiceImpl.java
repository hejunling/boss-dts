...
public class DXProvinceEntUserServiceImpl implements DXProvinceEntUserService {
    private static final Logger logger = LoggerFactory.getLogger(DXProvinceEntUserServiceImpl.class);
