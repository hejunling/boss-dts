...
public class DXProvincePersonalUserServiceImpl implements DXProvincePersonalUserService {

    private static final Logger logger = LoggerFactory.getLogger(DXProvincePersonalUserServiceImpl.class);
    ...
    private void reopenUserInfo(BizUserInfo bizUserInfo) {
        ...
        userInfo.setCanceldatetime(null);
    ...
    private void transformUserInfo(BizUserInfo bizUserInfo, UserInfo userInfo) {
        ...
        userInfo.setCanceldatetime(bizUserInfo.getOfftime());
