...
public class DXProvinceBizComboInfoServiceImpl implements DXProvinceBizComboInfoService {

    public static final Logger logger = LoggerFactory.getLogger(DXProvinceBizComboInfoServiceImpl.class);
